...
class minecraft {
	...
	public function get_data() {
		...
		return array(
			'general' => array(
				...
				'maximum_online_players' => $data['players']['max'],
				'map' => 'false'
			),
			...
			'details' => array(
				'description' => $this->decodeMotd($data['description']),
				'server_version' => $data['version']['name']
			)
		); 
	...
	private function receive() {
		...
		/* Decode JSON */
		//$data = json_decode(substr($data, 4), true);
	...
	private function decodeMotd($minetext) {
